...
NOTE: If you're interested in exposing JPA repositories with a hypermedia-based RESTful front end with little effort, you might want to read https://github.com/spring-guides/gs-accessing-data-rest[Accessing JPA Data with REST].
